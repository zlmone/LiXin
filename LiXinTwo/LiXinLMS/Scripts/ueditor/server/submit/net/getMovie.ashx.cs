...
namespace InvincibleWebUI.Scripts.ueditor.server.submit.net
{
    public class getMovie : IHttpHandler
    {
        public void ProcessRequest(HttpContext context)
        {
            ...
            var httpURL =
                new Uri("http://api.tudou.com/v3/gw?method=item.search&appKey=myKey&format=json&kw=" + key +
                        "&pageNo=1&pageSize=20&channelId=" + type + "&inDays=7&media=v&sort=s");
