...
function ckstyle() { //定义总的风格
    var ck = new Object();
    ck.cpath = '/Scripts/ckplayer5.8/assets/'; //风格总路径
    ck.mylogo = 'Null';
    ck.logo = 'Null,2,100,10';
...
function ckplayer_hqurl(str) {
    ...
    var dqweburl = document.location.protocol + '//' + hostname;
    var lagree = '';
    var iswb = 0;
    var geturl = '';
    var geturlt = '';
...
function swfupload() {
    ...
    this.swfwrite = function(str) {
        ...
        swfhtml += '    <embed wmode="opaque" src="' + this.ckplayer_url + '" flashvars="v=' + this.ckplayer_volume + '&p=' + this.ckplayer_play + '&f=' + this.ckplayer_flv + '&i=' + this.ckplayer_loadimg + '&d=' + this.ckplayer_pauseflash + '&u=' + this.ckplayer_pauseurl + '&l=' + this.ckplayer_loadadv + '&r=' + this.ckplayer_loadurl + '&t=' + this.ckplayer_loadtime + '&e=' + this.ckplayer_endstatus + '&a=' + this.ckplayer_pat + '&s=' + this.ckplayer_style + '&x=' + this.ckplayer_xml + '&c=' + this.ckplayer_default + '&b=' + this.ckplayer_bgcolor + '&h=' + this.ckplayer_http + '&m=' + this.ckplayer_load + '&g=' + this.ckplayer_start + '&j=' + this.ckplayer_ending + '&k=' + this.ckplayer_prompt + '&n=' + this.ckplayer_prompttext + '" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="' + this.ckplayer_width + '" height="' + this.ckplayer_height + '" allowFullScreen="' + this.ckplayer_allowFullScreen + '"';
