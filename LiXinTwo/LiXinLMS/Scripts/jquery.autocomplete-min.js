...
(function(d) {
    ...
    var m = new RegExp("(\\/|\\.|\\*|\\+|\\?|\\||\\(|\\)|\\[|\\]|\\{|\\}|\\\\)", "g");
    d.fn.autocomplete = function(b) { return new i(this.get(0) || d("<input />"), b); };
    i.prototype = {
        killerFn: null,
        initialize: function() {
            var b, a, c;
            ...
            this.el.focus(function() { b.fixPosition(); });
        },
        ...
        fixPosition: function() {
            ...
            d("#" + this.mainContainerId).css({ top: b.top + this.el.innerHeight() + "px", left: b.left + "px" });
        },
        enableKillerFn: function() { d(document).bind("click", this.killerFn); },
        disableKillerFn: function() { d(document).unbind("click", this.killerFn); },
            ...
            if (!this.disabled) {
                ...
                if (this.currentValue !== this.el.val())
                    if (this.options.deferRequestBy > 0) {
                        var a = this;
                        this.onChangeInterval = setInterval(function() { a.onValueChange(); }, this.options.deferRequestBy);
        ...
        getSuggestions: function(b) {
            ...
            if ((a = this.isLocal ? this.getSuggestionsLocal(b) : this.cachedResponse[b]) && d.isArray(a.suggestions)) {
                ...
                d.get(this.serviceUrl, c.options.params, function(e) { c.processResponse(e); }, "text");
            }
        },
        isBadQuery: function(b) {
            for (var a = this.badQueries.length; a--;) if (b.indexOf(this.badQueries[a]) === 0) return true;
            return false;
        },
        hide: function() {
            this.enabled = false;
        ...
        suggest: function() {
            if (this.suggestions.length === 0) this.hide();
                ...
                j = function(h) { return function() { b.activate(h); }; };
                k = function(h) { return function() { b.select(h); }; };
