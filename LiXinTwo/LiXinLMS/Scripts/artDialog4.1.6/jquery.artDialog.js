 ...
 */(function(h, e, l) {
    ...
    var r = e.VBArray && !e.XMLHttpRequest, t = "createTouch" in document && !("onmousemove" in s) || /(iPhone|iPad|iPod)/i.test(navigator.userAgent), w = "artDialog" + +new Date, g = function(a, b, c) {
        ...
        h.each({ ok: "yesFn", cancel: "noFn", close: "closeFn", init: "initFn", okVal: "yesText", cancelVal: "noText" }, function(b, d) { a[b] = a[b] !== l ? a[b] : a[d]; });
    ...
    g.fn = g.prototype = {
        ...
        content: function(a, b) {
            ...
            if ("string" === typeof a) u.html(a);
                ...
                i = a.style.display, c = a.previousSibling, d = a.nextSibling, f = a.parentNode, k._elemBack = function() {
        ...
        _ie6PngFix: r ? function() { for (var a = 0, b, c, d = g.defaults.path + "/skins/", f = this.DOM.wrap[0].getElementsByTagName("*"); a < f.length; a++) if (b = f[a], c = b.currentStyle.png) c = d + c, b = b.runtimeStyle, b.backgroundImage = "none", b.filter = "progid:DXImageTransform.Microsoft.AlphaImageLoader(src='" + c + "',sizingMethod='crop')"; } : h.noop,
        ...
        _setFixed: function() {
            r && h(function() { "fixed" !== m.css("backgroundAttachment") && "fixed" !== h("body").css("backgroundAttachment") && m.css({ zoom: 1, backgroundImage: "url(about:blank)", backgroundAttachment: "fixed" }); });
            return function() {
    ...
    g.focus = null;
    g.get = function(a) { return a === l ? g.list : g.list[a]; };
    g.list = {};
    ...
    g._templates = '<div class="aui_outer"><table class="aui_border"><tbody><tr><td class="aui_nw"></td><td class="aui_n"></td><td class="aui_ne"></td></tr><tr><td class="aui_w"></td><td class="aui_c"><div class="aui_inner"><table class="aui_dialog"><tbody><tr><td colspan="2" class="aui_header"><div class="aui_titleBar"><div class="aui_title"></div><a class="aui_close" href="javascript:/*artDialog*/;">\u00d7</a></div></td></tr><tr><td class="aui_icon"><div class="aui_iconBg"></div></td><td class="aui_main" style="vertical-align:top;"><div class="aui_content"></div></td></tr><tr><td colspan="2" class="aui_footer"><div class="aui_buttons"></div></td></tr></tbody></table></div></td><td class="aui_e"></td></tr><tr><td class="aui_sw"></td><td class="aui_s"></td><td class="aui_se"></td></tr></tbody></table></div>';
    g.defaults = { content: '<div class="aui_loading"><span>loading..</span></div>', title: "\u6d88\u606f", button: null, ok: null, cancel: null, init: null, close: null, okVal: "\u786e\u5b9a", cancelVal: "\u53d6\u6d88", width: "auto", height: "auto", minWidth: 96, minHeight: 32, padding: "20px 25px", skin: "", icon: null, time: null, esc: !0, focus: !0, show: !0, follow: null, path: v, lock: !1, background: "#000", opacity: 0.5, duration: 300, fixed: !1, left: "50%", top: "38.2%", zIndex: 1987, resize: !0, drag: !0 };
...
(function(h) {
    ...
    artDialog.dragEvent = function() {
        var j = this, e = function(e) {
            var h = j[e];
            j[e] = function() { return h.apply(j, arguments); };
        };
        e("start");
        e("move");
        e("end");
    ...
    l = function(h) {
        var m, l, t, s, g, x, y = artDialog.focus, a = y.DOM, b = a.wrap, c = a.title, d = a.main, f = "getSelection" in window ? function() { window.getSelection().removeAllRanges(); } : function() {
            try {
