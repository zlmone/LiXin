		...
		public string Status
		{
			get
			{
				...
				else if (AttFlag == 1)
				{
					...
					if (Convert.ToDateTime(AttendceStartTime.ToString("g")) > Convert.ToDateTime(StartTime.ToString("g")))
					{
						return "迟到" + (Convert.ToDateTime(AttendceStartTime.ToString("g")).Subtract(Convert.ToDateTime(StartTime.ToString("g"))).TotalMinutes).ToString("0") + "(min)";
					}
					if (Convert.ToDateTime(AttendceStartTime.ToString("g")) <= Convert.ToDateTime(StartTime.ToString("g")))
					{
						return "正常";
				...
				else if (AttFlag == 2)
				{
					...
					if (Convert.ToDateTime(AttendceEndTime.ToString("g")) < Convert.ToDateTime(EndTime.ToString("g")))
					{
						return "早退" + (Convert.ToDateTime(AttendceEndTime.ToString("g")).Subtract(Convert.ToDateTime(EndTime.ToString("g"))).TotalMinutes * -1).ToString("0") + "(min)";
					}
					if (Convert.ToDateTime(AttendceEndTime.ToString("g")) >= Convert.ToDateTime(EndTime.ToString("g")))
					{
						return "正常";
						...
						AttendceEndTime != Convert.ToDateTime("2000-1-1"))
					{
						...
						else
						{
							return "迟到/早退<span class='f11'>" +
								   (Convert.ToDateTime(AttendceEndTime.ToString("g")).Subtract(Convert.ToDateTime(EndTime.ToString("g"))).TotalMinutes * -1).ToString("0") + "(min)</span>";
						}
						...
						AttendceEndTime == Convert.ToDateTime("2000-1-1"))
					{
						...
						else
						{
							return "迟到<span class='f11'>" +
								   (Convert.ToDateTime(AttendceStartTime.ToString("g")).Subtract(Convert.ToDateTime(StartTime.ToString("g"))).TotalMinutes).ToString("0") +
								   "(min)</span>/早退";
						}
					}
					if (AttendceStartTime != Convert.ToDateTime("2050-1-1") &&
						AttendceEndTime != Convert.ToDateTime("2000-1-1"))
					{
						if (Convert.ToDateTime(AttendceStartTime.ToString("g")) <= Convert.ToDateTime(StartTime.ToString("g")) && Convert.ToDateTime(AttendceEndTime.ToString("g")) >= Convert.ToDateTime(EndTime.ToString("g")))
						{
							return "正常";
						}
						else if (Convert.ToDateTime(AttendceStartTime.ToString("g")) > Convert.ToDateTime(StartTime.ToString("g")) && Convert.ToDateTime(AttendceEndTime.ToString("g")) >= Convert.ToDateTime(EndTime.ToString("g")))
						{
							return "迟到" + (Convert.ToDateTime(AttendceStartTime.ToString("g")).Subtract(Convert.ToDateTime(StartTime.ToString("g"))).TotalMinutes).ToString("0") +
								   "(min)";
						}
						else if (Convert.ToDateTime(AttendceStartTime.ToString("g")) > Convert.ToDateTime(StartTime.ToString("g")) && Convert.ToDateTime(AttendceEndTime.ToString("g")) < Convert.ToDateTime(EndTime.ToString("g")))
						{
		...
		public string AttStatusShow
		{
			get
			{
				...
				else if (AttFlag == 1)
				{
					...
					if (AttendceStartTime > CourseStartTime)
					{
				...
				else if (AttFlag == 2)
				{
					...
					if (AttendceEndTime < CourseEndTime)
					{
				...
				else if (AttFlag == 3)
				{
					...
					if (AttendceStartTime != Convert.ToDateTime("2050-1-1") &&
						AttendceEndTime != Convert.ToDateTime("2000-1-1"))
					{
						if (AttendceStartTime <= CourseStartTime && AttendceEndTime >= CourseEndTime)
						{
							return "正常";
						}
						if (AttendceStartTime > CourseStartTime && AttendceEndTime > CourseEndTime)
