...
namespace LiXinInterface.User
{
    public interface IUser
    {
        ...
        /// <returns></returns>
        decimal GetUserScore(int uid,int year, Sys_ParamConfig cpazq, bool flag = true);
        ...
        /// <returns></returns>
        Sys_User GetmodelCAP(int uid, int year);
        ...
        /// CPA年度课程
        /// </summary>
        List<Co_CourseShow> GetMyCPACourse(int userid, int year,string Order = "asc", string where = "1=1");

        /// <summary>
        /// CPA周期课程
        /// </summary>
        List<Co_CourseShow> GetMyCPACourse(int userid, string bentime, string endtime,string Order = "asc", string where = "1=1");
        #endregion
    }
}