...
namespace LiXinInterface.AttendceManage
{
    public interface IAttendce
    {
        ...
        /// </summary>
        /// <returns></returns>
        List<Cl_Attendce> GetAttendUserList(int CourseId, string Order = "asc", string where = "1=1", string overwhere = " 1=1");
        ...
        void AddAttendce(int CourseId, int userid, string starttime, string endtime,int AttStatus);
        ...
        /// 判断补预订是否超出规定值
        /// </summary>
        bool Cl_MakeUpOrderCount(int count, int userid,int year=0);
