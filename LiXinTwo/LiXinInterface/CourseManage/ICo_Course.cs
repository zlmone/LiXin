...
namespace LiXinInterface.CourseManage
{
    public interface ICo_Course
    {
        ...
        /// </summary>
        /// <param name="model"></param>
        int AddOpenCourse(Co_Course model);
        ...
        List<Co_Course> GetCourseCommonListByJiZhong(out int totalCount, int userid, string where = " 1 = 1 ", int startIndex = 0,
                                      int pageLength = int.MaxValue, string orderBy = "ORDER BY Co_Course.Code,Co_Course.Id DESC");
        ...
        List<Co_Course> GetMyReportList(string where = " 1 = 1 ", int Userid = 0);
