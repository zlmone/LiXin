...
namespace LiXinInterface.MyApproval
{
    ...
    public interface IMyApproval
    {
        ...
        /// <param name="orderBy">排序条件</param>
        /// <returns></returns>
        List<PrincipleInfor> GetMyApprovalPrinciplePagingForNew(out int totalCount, string where = " and 1 = 1 ",
                                                                 int startIndex = 0, int pageLength = int.MaxValue,
                                                                 string orderBy = " order by a.AppDateTime desc ");
        ...
        /// <summary>
        /// 获取我的违纪情况列表 所有状态:迟到-早退-缺勤-迟到且早退 2013-10-11 毛佳源
        /// </summary>
        /// <param name="totalCount">总数</param>
        /// <param name="where">查询条件</param>
        /// <param name="startIndex">开始页数</param>
        ...
        /// <param name="orderBy">排序条件</param>
        /// <returns></returns>
        List<PrincipleInfor> GetMyPrinciplePagingAllType(out int totalCount, string where = " and 1 = 1 ",
                                                             int startIndex = 0, int pageLength = int.MaxValue,
                                                             string orderBy = " order by a.AppDateTime desc ");
