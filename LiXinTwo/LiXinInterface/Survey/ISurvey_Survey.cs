...
namespace LiXinInterface.Survey
{
    public interface ISurvey_Survey
    {
        ...
        /// <param name="surveyID"></param>
        /// <returns></returns>
        List<Survey_user> GetUserNoJoin(out int totalcount, int SurveyID, int startIndex = 1, int startLength = int.MaxValue, string where = "1=1", string jsRenderSortField = " userID desc");
        ...
        /// <param name="SurveyID"></param>
        /// <returns></returns>
        List<Survey_user> GetUserAnswer(out int toalcount, int SurveyID, int startIndex = 1, int startLength = int.MaxValue, string where = "1=1", string jsRenderSortField = " SubmitTime desc");
