...
namespace LiXinControllers.User
{
    public class UserCommonController : BaseController
    {
        ...
        public ActionResult SelectUser(string type = "checkbox", int deptId = 0, int postId = 0, string model = "",
                                       int NotShowHasPost = 0, int NotShowHasDept = 0, int pageSize = 10, string flag = "")
        {
            ViewBag.type = type;
        ...
        public ActionResult SelectUserByGroup(string ids, int TokenPublishflag = 0, string tempGroupIds = "")
        {
        ...
        public ActionResult SelectTeacher(string type = "radio", int choose= 0,int way=0)
        {
        ...
        public ActionResult SelectTeacherNew(string type = "radio", int deptId = 0, int postId = 0, string model = "",
                                      int NotShowHasPost = 0, int NotShowHasDept = 0, int pageSize = 10, string flag = "")
        {
            ViewBag.type = type;
            ViewBag.pageSize = pageSize;
