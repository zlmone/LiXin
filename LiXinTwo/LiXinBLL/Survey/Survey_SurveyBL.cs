...
namespace LiXinBLL.Survey
{
    public class Survey_SurveyBL : ISurvey_Survey
    {
        ...
        /// <param name="surveyID"></param>
        /// <returns></returns>
        public List<Survey_user> GetUserNoJoin(out int totalcount, int SurveyID, int startIndex = 1, int startLength = int.MaxValue, string where = "1=1", string jsRenderSortField = " userID desc")
        {
           // return surveyDB.GetUserNoJoin(surveyID);
            var list = surveyDB.GetUserNoJoin(SurveyID, startIndex, startLength, where, jsRenderSortField);
        ...
        /// <param name="SurveyID"></param>
        /// <returns></returns>
        public List<Survey_user> GetUserAnswer(out int totalcount,int SurveyID, int startIndex = 1, int startLength = int.MaxValue, string where = "1=1", string jsRenderSortField = " SubmitTime desc")
        {
            var list =surveyDB.GetUserAnswer(SurveyID, startIndex, startLength, where, jsRenderSortField);
            totalcount = list.Count == 0 ? 0 : list.FirstOrDefault().totalcount;
            return list;
        }
        #endregion
