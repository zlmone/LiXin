...
"ipt src=\"");
            ...
            #line 15 "..\..\Views\Exampaper\ExamQuestionList.cshtml"
...
<div class=""clb"">
    ...
    <div class=""fr span65 ml10"">
        <div id=""Search"" class=""so-set"">
            ...
            #line 25 "..\..\Views\Exampaper\ExamQuestionList.cshtml"
...
"\"btnSearch\" value=\"");
            ...
            #line 27 "..\..\Views\Exampaper\ExamQuestionList.cshtml"
...
WriteLiteral("</option>\r\n                <option value=\"6\">");
            ...
            #line 39 "..\..\Views\Exampaper\ExamQuestionList.cshtml"
...
WriteLiteral("</option>\r\n                <option value=\"3\">");
            ...
            #line 45 "..\..\Views\Exampaper\ExamQuestionList.cshtml"
...
WriteLiteral(@"</option>
        ...
        <div id=""question"">
            ...
            #line 56 "..\..\Views\Exampaper\ExamQuestionList.cshtml"
...
"          ");
            ...
            #line 59 "..\..\Views\Exampaper\ExamQuestionList.cshtml"
...
"          ");
            ...
            #line 62 "..\..\Views\Exampaper\ExamQuestionList.cshtml"
...
"          ");
            ...
            #line 65 "..\..\Views\Exampaper\ExamQuestionList.cshtml"
...
"          ");
            ...
            #line 68 "..\..\Views\Exampaper\ExamQuestionList.cshtml"
...
<center class=""mt10""><input type=""button"" id=""btnAdd"" class=""btn"" value=""");
            ...
            #line 80 "..\..\Views\Exampaper\ExamQuestionList.cshtml"
                                                                    Write(Exampaper.Add);
...
WriteLiteral("\', 3);\r\n                //art.dialog({ title: \'");
            ...
            #line 149 "..\..\Views\Exampaper\ExamQuestionList.cshtml"
...
WriteLiteral("@\" onclick=\"Delete(\' + data[i - 1]._id + \')\" title=\"");
            ...
            #line 167 "..\..\Views\Exampaper\ExamQuestionList.cshtml"
...
" type=\"radio\" disabled=\"disabled\" /><label>");
            ...
            #line 185 "..\..\Views\Exampaper\ExamQuestionList.cshtml"
...
"            //art.dialog({ title: \'");
            ...
            #line 215 "..\..\Views\Exampaper\ExamQuestionList.cshtml"
                                              Write(CommonLanguage.Common_Tip);

            
            #line default
            #line hidden
WriteLiteral(@"', content: errorThrown, width: 200, height: 50, fixed: true, lock: true, time: 1000 });
                        }
                    });
                }
            }
    ...
    function initQuestionSort() {
        $.getJSON(""/Question/GetAllQuestionSortTree?deptId=");


            
            #line 226 "..\..\Views\Exampaper\ExamQuestionList.cshtml"
                                                       Write(deptId);
...
" HiddenSelect();\r\n            }\r\n        });\r\n\r\n\r\n    }\r\n\r\n    function HiddenSe" +
"lect() {\r\n        if ($(\"#QuestionIDs\") != undefined && $(\"#QuestionIDs\") != nul" +
"l && $(\"#QuestionIDs\") != \"\") {\r\n            $(\"#questionList td input[type=\'che" +
"ckbox\']\").each(function() {\r\n                if ((\',\' + $(\"#QuestionIDs\").val() " +
"+ \',\').indexOf(\',\' + $(this).attr(\'value\') + \',\') >= 0) {\r\n                    $" +
"(this).attr(\'disabled\', \'disabled\');\r\n                }\r\n            });\r\n      " +
"  }\r\n    }\r\n\r\n//问题分类树点击事件\r\n\r\n    function selectSort(id, obj) {\r\n        $(\"#sel" +
"QuestionSort\").val(id);\r\n        $(\"#selQuestionType\").val(\"0\");\r\n        $(\"#se" +
"lQuestionLevel\").val(\"0\");\r\n        $(\"#txtQuestionContent\").val(\"\");\r\n        I" +
"nitializeTargetList(getUrlParms());\r\n\r\n    }\r\n\r\n    //生成url参数字符串\r\n\r\n    function" +
" getUrlParms() {\r\n        return \'/Question/GetAllQuestion?sortID=\' + $(\"#selQue" +
"stionSort\").val() +\r\n            \'&type=\' + $(\"#selQuestionType\").val() +\r\n     " +
"       \'&level=\' + $(\"#selQuestionLevel\").val() +\r\n            \'&deptId=");


            
            #line 286 "..\..\Views\Exampaper\ExamQuestionList.cshtml"
                 Write(deptId);

            
            #line default
            #line hidden
WriteLiteral("\' +\r\n            \'&content=\' + escape($(\"#txtQuestionContent\").val()) + \'&t=\' + n" +
"ew Date();\r\n    }\r\n</script>");
