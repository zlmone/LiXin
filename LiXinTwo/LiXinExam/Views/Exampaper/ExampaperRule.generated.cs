...
<div id=""mdiv"">
    <div class=""exam-sel"">
        ...
        <table name=""subdiv"" class=""tab-Form"">
            ...
            #line 16 "..\..\Views\Exampaper\ExampaperRule.cshtml"
...
WriteLiteral("</option>\r\n                        <option value=\"6\">");
            ...
            #line 24 "..\..\Views\Exampaper\ExampaperRule.cshtml"
...
"");
            ...
            #line 29 "..\..\Views\Exampaper\ExampaperRule.cshtml"
...
WriteLiteral(@"：</td>
            ...
            #line 43 "..\..\Views\Exampaper\ExampaperRule.cshtml"
...
WriteLiteral("：</td>\r\n                <td>\r\n                    <span>");
            ...
            #line 45 "..\..\Views\Exampaper\ExampaperRule.cshtml"
...
WriteLiteral(@"：</span>
            ...
            #line 48 "..\..\Views\Exampaper\ExampaperRule.cshtml"
...
WriteLiteral(@"：</span>
            ...
            #line 51 "..\..\Views\Exampaper\ExampaperRule.cshtml"
...
WriteLiteral(@"：</span>
        ...
        <a id=""delDefault1"" name=""rmlink"" title=""");
            ...
            #line 57 "..\..\Views\Exampaper\ExampaperRule.cshtml"
...
"ue=\"");
            ...
            #line 62 "..\..\Views\Exampaper\ExampaperRule.cshtml"
...
"QuestionSort(idi) {\r\n        var openurl = \"/Question/GetQSortTree?deptId=");
            ...
            #line 67 "..\..\Views\Exampaper\ExampaperRule.cshtml"
                                                 Write(deptId);
...
"\r\n            art.dialog({\r\n                title: \"");
            ...
            #line 70 "..\..\Views\Exampaper\ExampaperRule.cshtml"
...
WriteLiteral("\',\r\n                content: \'");
            ...
            #line 104 "..\..\Views\Exampaper\ExampaperRule.cshtml"
...
WriteLiteral(@"',
    ...
    function statusChange(iq) {
        $.ajax({
            ...
            #line 117 "..\..\Views\Exampaper\ExampaperRule.cshtml"
                                                    Write(deptId);
...
" str)) > 1) {\r\n            flag = false;\r\n        }\r\n        return flag;\r\n    }" +
"\r\n\r\n    function ckque1(str) {\r\n        var tmp = $(\'#divExamQuestions\').find(\'i" +
"nput[name=qru]\');\r\n        var eqidss = \"\";\r\n        var flag = true;\r\n        f" +
"or (var g = 0; g < tmp.length; g++) {\r\n            if (tmp[g].value != \"\" && tmp" +
"[g].value != null) {\r\n                eqidss = eqidss + tmp[g].value + \",\";\r\n   " +
"         }\r\n        }\r\n        if (parseInt(countInstances(eqidss, str)) > 0) {\r" +
"\n            flag = false;\r\n        }\r\n        return flag;\r\n    }\r\n\r\n//FROM验证\r\n" +
...
"var r = /^[0-9]*[1-9][0-9]*$/;\r\n        var frombool = true;\r\n        var sosun " +
"= 0;\r\n        var zsun = 0;\r\n        if (parseInt(Easy) > 0 || parseInt(Common) " +
"> 0 || parseInt(Hard) > 0) {\r\n            if (parseInt(Easy) > 0) {\r\n           " +
"     if (easyc == null || easyc == \"\" || easyc == 0) {\r\n                    sosu" +
"n = sosun + 1;\r\n                } else {\r\n                    if (!(r.test(easyc" +
")) || parseInt(easyc) > parseInt(Easy)) {\r\n                        frombool = fa" +
"lse; \r\n                    }\r\n                }\r\n                zsun = zsun+1;\r" +
"\n            }\r\n            if (parseInt(Common) > 0) {\r\n                if (com" +
"monc == null || commonc == \"\" || commonc == 0) {\r\n                    sosun = so" +
"sun + 1;\r\n                } else {\r\n                    if (!(r.test(commonc)) |" +
"| parseInt(commonc) > parseInt(Common)) {\r\n                        frombool = fa" +
"lse;\r\n                        \r\n                    }\r\n                }\r\n      " +
"          zsun = zsun + 1;\r\n            }\r\n            if (parseInt(Hard) > 0) {" +
"\r\n                if (hardc == null || hardc == \"\" || hardc == 0) {\r\n           " +
"         sosun = sosun + 1;\r\n                } else {\r\n                    if (!" +
"(r.test(hardc)) || parseInt(hardc) > parseInt(Hard)) {\r\n                        " +
"frombool = false;\r\n                    }\r\n                }\r\n                zsu" +
...
"n ckfrom() {\r\n        var tmp = $(\'#mdiv\').find(\'input[name=random]\');\r\n        " +
"var eroor = \"\";\r\n        for (var g = 0; g < tmp.length; g++) {\r\n            if " +
"(tmp[g].value != \"\" && tmp[g].value != null) {\r\n                var QuestionType" +
" = \"#selQuestionType\" + tmp[g].value;\r\n                var QuestionSort = \"#selQ" +
"uestionSort\" + tmp[g].value;\r\n                var txtQuestionsum = \"#txtQuestion" +
"sum\" + tmp[g].value;\r\n\r\n                if ($(QuestionType).val() != \"\" && $(Que" +
"stionSort).val() != \"\" && $(txtQuestionsum).val() != \"\" && $(QuestionType).val()" +
" != null && $(QuestionSort).val() != null && $(txtQuestionsum).val() != null) {\r" +
"\n                    var r = /^[0-9]*[1-9][0-9]*$/;\r\n                    var va " +
"= $(txtQuestionsum).val();\r\n                    if (!(r.test(va)) || parseInt(va" +
") < 1 || parseInt(va) > 100) {\r\n                        eroor = \"分值请输入1-100的正整数\"" +
";\r\n                    } else {\r\n                        var que = $(QuestionTyp" +
"e).val() + \"|\" + $(QuestionSort).val();\r\n                        if (!ckque(que)" +
") {\r\n                            eroor = \"请不要选择重复的组卷条件\";\r\n                      " +
"  } else {\r\n                            if (!ckque1(que)) {\r\n                   " +
"             eroor = \"组卷规则已存在，请重新选择\";\r\n                            } else {\r\n   " +
...
"ar QuestionSort = \"#selQuestionSort\" + numid;\r\n        if ($(\"#sortName\" + numid" +
").val() != \"\" && $(\"#sortName\" + numid).val() != null) {\r\n            if ($(\"#tx" +
"tQuestionsum\" + numid).val() != \"\") {\r\n                var que = $(QuestionType)" +
".val() + \"|\" + $(QuestionSort).val();\r\n                if (ckque(que)) {\r\n      " +
"              if (ckque1(que)) {\r\n                        if (CheckLevel(numid))" +
" {\r\n                            $(\"#delDefault\" + numid).show();\r\n              " +
"              var mid = parseInt(numid) + 1;\r\n                            var li" +
"HTML = \'<div class=\"exam-sel\"><input type=\"hidden\" name=\"random\" value=\"\' + mid " +
"+ \'\"/><table name=\"subdiv\" class=\"tab-Form\">\';\r\n                            liHT" +
"ML += \'<tr>\';\r\n                            liHTML += \'<td class=\"Tit\"><span clas" +
"s=\"must\">*</span>");


            
            #line 301 "..\..\Views\Exampaper\ExampaperRule.cshtml"
                                                                             Write(Exampaper.qType);
...
WriteLiteral("</option>\';\r\n                            liHTML += \'<option value=\"6\">");
            ...
            #line 308 "..\..\Views\Exampaper\ExampaperRule.cshtml"
                                                    Write(Exampaper.Scene);
...
"");
            ...
            #line 310 "..\..\Views\Exampaper\ExampaperRule.cshtml"
                                                                             Write(Exampaper.qSort);
...
WriteLiteral("：</td><td>\';\r\n                            liHTML += \'<span>");
            ...
            #line 318 "..\..\Views\Exampaper\ExampaperRule.cshtml"
                                        Write(Question.Question_QuestionManage_EasyLevel);
...
WriteLiteral(@"：</span>';
            ...
            #line 321 "..\..\Views\Exampaper\ExampaperRule.cshtml"
                                                     Write(Question.Question_QuestionManage_CommonLevel);
...
WriteLiteral(@"：</span>';
            ...
            #line 324 "..\..\Views\Exampaper\ExampaperRule.cshtml"
                                                     Write(Question.Question_QuestionManage_HardLevel);
...
WriteLiteral(@"：</span>';
            ...
            #line 328 "..\..\Views\Exampaper\ExampaperRule.cshtml"
                                                                                     Write(CommonLanguage.Common_Delete);
...
WriteLiteral(@""" class=""icon idel"" title=""删除""></a>';
            ...
            #line 344 "..\..\Views\Exampaper\ExampaperRule.cshtml"
                                              Write(CommonLanguage.Common_Tip);
...
"{ title: \'");
            ...
            #line 348 "..\..\Views\Exampaper\ExampaperRule.cshtml"
                                          Write(CommonLanguage.Common_Tip);
...
"");
            ...
            #line 352 "..\..\Views\Exampaper\ExampaperRule.cshtml"
                                      Write(CommonLanguage.Common_Tip);
...
"ps(\"请输入分值\", 3);\r\n                //art.dialog({ title: \'");
            ...
            #line 356 "..\..\Views\Exampaper\ExampaperRule.cshtml"
                                  Write(CommonLanguage.Common_Tip);
...
"          //art.dialog({ title: \'");
            ...
            #line 360 "..\..\Views\Exampaper\ExampaperRule.cshtml"
                              Write(CommonLanguage.Common_Tip);
...
WriteLiteral(@"', content: ""请选择题库"", width: 400, height: 100, fixed: true, lock: true, time: 3 });
    ...
    function bindListener() {
        $(""a[name=rmlink]"").unbind().click(function() {
            ...
            #line 381 "..\..\Views\Exampaper\ExampaperRule.cshtml"
                                  Write(CommonLanguage.Common_Tip);
...
"           strhtml += \'<p class=\"tit\">");
            ...
            #line 439 "..\..\Views\Exampaper\ExampaperRule.cshtml"
                                                  Write(Exampaper.qType);
...
"                strhtml += \'<p class=\"tit\">");
            ...
            #line 441 "..\..\Views\Exampaper\ExampaperRule.cshtml"
                                                  Write(Exampaper.qSort);
...
WriteLiteral(@"：</p>';
            ...
            #line 444 "..\..\Views\Exampaper\ExampaperRule.cshtml"
                                                  Write(Exampaper.qLevel);
...
WriteLiteral(@"：</p>';
            ...
            #line 448 "..\..\Views\Exampaper\ExampaperRule.cshtml"
                                                           Write(CommonLanguage.Common_Delete);
...
WriteLiteral(@""" class=""icon idel""></a>';
            ...
            #line 461 "..\..\Views\Exampaper\ExampaperRule.cshtml"
                                  Write(CommonLanguage.Common_Tip);
