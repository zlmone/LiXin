...
namespace LiXinExam.Controllers
{
    public class ExaminationController : BaseController
    {
        ...
        /// <returns></returns>
        [HttpPost]
        [LiXinControllers.Filter.SystemLog("编辑考试", LogLevel.Info)]
        ...
        /// <returns></returns>
        [HttpPost]
        [LiXinControllers.Filter.SystemLog("发布考试", LogLevel.Info)]
        ...
        /// <returns></returns>
        [HttpPost]
        [LiXinControllers.Filter.SystemLog("删除考试", LogLevel.Info)]
        ...
        /// <returns></returns>
        [HttpPost]
        [LiXinControllers.Filter.SystemLog("发布考试成绩", LogLevel.Info)]
        ...
        /// <returns></returns>
        [HttpPost]
        [LiXinControllers.Filter.SystemLog("考试管理 复评", LogLevel.Info)]
