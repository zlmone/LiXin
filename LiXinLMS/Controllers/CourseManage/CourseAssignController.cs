...
", courseId, leaderId);
        ...
        public JsonResult SubmitSendEmail()
        {
            //List<string> listEmailAddress = new List<string>();
            //listEmailAddress.Add("huihh@retechcorp.com");
            //listEmailAddress.Add("649806935@qq.com");
            string strTitle = "研发中心测试";
            var list = new List<KeyValuePair<string, string>>();
            list.Add(new KeyValuePair<string, string>("huihh@retechcorp.com", "惠洪浩立信测试"));
            list.Add(new KeyValuePair<string, string>("649806935@qq.com", "惠洪浩qq邮箱立信测试"));
