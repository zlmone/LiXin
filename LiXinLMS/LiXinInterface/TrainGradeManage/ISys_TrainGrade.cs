...
namespace LiXinInterface
{
    public interface ISys_TrainGrade
    {
        ...
        List<Sys_TrainGrade> GetUserTrain(out int totalCount, int userID, int pageIndex = 1, int pageSize = int.MaxValue, string realName = "", string JobNum = "", string payGrade = "", string deptName = "", string ordersql = "ORDER BY su.DeptPath asc,su.TrainGrade asc");
        ...
        void UpdateTrainMaster(int userID, int TrainMaster);
