 ...
 */(function(g, h) {
    ...
    var c = g.art = function(b, d) { return new c.fn.init(b, d); }, v = !1, r = [], s, l = "opacity" in document.documentElement.style, t = /^(?:[^<]*(<[\w\W]+>)[^>]*$|#([\w\-]+)$)/, m = /[\n\t]/g, q = /alpha\([^)]*\)/i, z = /opacity=([^)]*)/, x = /^([+-]=)?([\d+-.]+)(.*)$/;
    if (g.$ === h) g.$ = c;
    c.fn = c.prototype = {
        constructor: c,
        ready: function(b) {
        ...
        hasClass: function(b) { return -1 < (" " + this[0].className + " ").replace(m, " ").indexOf(" " + b + " ") ? !0 : !1; },
        addClass: function(b) {
    ...
    c.isWindow = function(b) { return b && "object" === typeof b && "setInterval" in b; };
    c.isArray = function(b) { return "[object Array]" === Object.prototype.toString.call(b); };
    ...
    c.event = {
        ...
        handler: function(b) { return function(d) { for (var d = c.event.fix(d || g.event), e = 0, a = b.listeners, f; f = a[e++];) !1 === f.call(b.elem, d) && (d.preventDefault(), d.stopPropagation()); }; },
        fix: function(b) {
            if (b.target) return b;
            var c = { target: b.srcElement || document, preventDefault: function() { b.returnValue = !1; }, stopPropagation: function() { b.cancelBubble = !0; } }, e;
            for (e in b) c[e] = b[e];
            return c;
        }
    };
    c.cleanData = function(b) { for (var d = 0, e, a = b.length, f = c.event.remove, k = c.removeData; d < a; d++) e = b[d], f(e), k(e); };
    c.isReady = !1;
    c.ready = function() {
        if (!c.isReady) {
    ...
    document.addEventListener ? s = function() {
        ...
        c.ready();
    } : document.attachEvent && (s = function() { "complete" === document.readyState && (document.detachEvent("onreadystatechange", s), c.ready()); });
    c.css = "defaultView" in document && "getComputedStyle" in document.defaultView ? function(b, c) { return document.defaultView.getComputedStyle(b, !1)[c]; } : function(b, d) { return ("opacity" === d ? c.opacity.get(b) : b.currentStyle[d]) || ""; };
    c.opacity = {
        get: function(b) { return l ? document.defaultView.getComputedStyle(b, !1).opacity : z.test((b.currentStyle ? b.currentStyle.filter : b.style.filter) || "") ? parseFloat(RegExp.$1) / 100 + "" : 1; },
        set: function(b, c) {
    ...
    c.ajax = function(b) {
        ...
        d.onreadystatechange = function() { if (4 === d.readyState && 200 === d.status) b.success && b.success(d.responseText), d.onreadystatechange = c.noop; };
        d.open("GET", e, 1);
        d.send(null);
    };
    c.fn.animate = function(b, d, e, a) {
        ...
        c.each(b, function(a, f) { o.curAnim[a] = f; });
    ...
    c.fx.prototype = {
        ...
        update: function() { "opacity" === this.prop ? c.opacity.set(this.elem, this.now) : this.elem.style && null != this.elem.style[this.prop] ? this.elem.style[this.prop] = this.now + this.unit : this.elem[this.prop] = this.now; }
    };
    c.fx.now = function() { return +new Date; };
    c.easing = { linear: function(b, c, e, a) { return e + a * b; }, swing: function(b, c, e, a) { return (-Math.cos(b * Math.PI) / 2 + 0.5) * a + e; } };
    c.fx.tick = function() {
...
(function(g, h, n) {
    ...
    var q = h.VBArray && !h.XMLHttpRequest, z = "createTouch" in document && !("onmousemove" in v) || /(iPhone|iPad|iPod)/i.test(navigator.userAgent), x = "artDialog" + +new Date, b = function(a, f, c) {
        ...
        g.each({ ok: "yesFn", cancel: "noFn", close: "closeFn", init: "initFn", okVal: "yesText", cancelVal: "noText" }, function(f, b) { a[f] = a[f] !== n ? a[f] : a[b]; });
    ...
    b.fn = b.prototype = {
        ...
        lock: function() {
            ...
            m.stop();
            m.bind("click", function() { a._reset(); }).bind("dblclick", function() { a._click(a.config.cancelVal); });
        ...
        _ie6PngFix: q ? function() { for (var a = 0, c, d, e = b.defaults.path + "/skins/", g = this.DOM.wrap[0].getElementsByTagName("*"); a < g.length; a++) if (c = g[a], d = c.currentStyle.png) d = e + d, c = c.runtimeStyle, c.backgroundImage = "none", c.filter = "progid:DXImageTransform.Microsoft.AlphaImageLoader(src='" + d + "',sizingMethod='crop')"; } : g.noop,
        ...
        _setFixed: function() {
            q && g(function() { "fixed" !== m.css("backgroundAttachment") && "fixed" !== g("body").css("backgroundAttachment") && m.css({ zoom: 1, backgroundImage: "url(about:blank)", backgroundAttachment: "fixed" }); });
            return function() {
        ...
        _addEvent: function() {
            ...
            e.wrap.bind("click", function(a) {
                ...
                b._ie6SelectFix();
            }).bind("mousedown", function() { b.zIndex(); });
        },
    ...
    b.focus = null;
    b.get = function(a) { return a === n ? b.list : b.list[a]; };
    b.list = {};
    ...
    l.bind("load", function() { setTimeout(function() { s || b({ left: "-9999em", time: 9, fixed: !1, lock: !1, focus: !1 }); }, 150); });
    try {
...
(function(g) {
    ...
    artDialog.dragEvent = function() {
        var c = this, g = function(g) {
            var h = c[g];
            c[g] = function() { return h.apply(c, arguments); };
        };
        g("start");
        g("move");
        g("end");
    ...
    n = function(g) {
        var m, q, n, x, b, d, e = artDialog.focus, a = e.DOM, f = a.wrap, k = a.title, w = a.main, v = "getSelection" in window ? function() { window.getSelection().removeAllRanges(); } : function() {
            try {
