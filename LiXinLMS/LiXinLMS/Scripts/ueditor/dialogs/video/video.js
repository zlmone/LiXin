...
(function() {
    ...
    function addOkListener() {
        dialog.onok = function() {
            ...
            case "videoSearch":
                ...
                break;
            case "videoUpload":
                return uploadSearchs("div_ImageName", "/UploadFile/Activities/");
                break;
            }
        };
    ...
    function uploadSearchs(div_ImageName, fold) {
        videoObjs = [];
        $("#" + div_ImageName).children("div").each(function() {
            videoObjs.push({
                url: fold + $(this).attr("title"),
                width: 300,
                height: 260,
                align: "none"
            });
...
/**
    ...
    function getMovie() {
        ...
        jQuery.post("../../server/submit/net/getMovie.ashx", { searchKey: keyword, videoType: type }, function(data) {
            try {
                var info = eval("(" + data + ")");
            } catch(e) {
                return;
