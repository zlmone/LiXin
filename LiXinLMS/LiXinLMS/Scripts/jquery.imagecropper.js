...
(function ($) {
    $.fn.extend({
        imageCropper: function (options) {
            ...
            var defaults = {
                ...
                //工作区大小
                cropWorkAreaSize: { width: 320, height: 320 },
                //截取框相对于工作区的位置
                cropFrameRect: { center: true, top: 1, left: 1 },
                //缩放范围
    ...
    imageCropper.prototype = {
        ...
        reset: function (obj) {
            ...
            cropcenter = this.settings.cropFrameRect.center;
            ...
            setcenter = this.settings.center;
