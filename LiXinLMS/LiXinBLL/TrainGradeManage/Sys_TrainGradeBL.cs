...
namespace LiXinBLL
{
    public class Sys_TrainGradeBL : ISys_TrainGrade
    {
        ...
        public List<Sys_TrainGrade> GetUserTrain(out int totalCount, int userID, int pageIndex = 1, int pageSize = int.MaxValue, string realName = "", string JobNum = "", string payGrade = "", string deptName = "", string ordersql = "ORDER BY su.DeptPath asc,su.TrainGrade asc")
        {
            string where = "";
            ...
            var list = trainDB.GetUserTrain(DateTime.Now.Year, userID, where, pageIndex, pageSize,ordersql);
        ...
        public void UpdateTrainMaster(int userID, int TrainMaster)
        {
            if (TrainMaster == 0)
            {
                trainDB.UpdateTrainMaster(userID, " TrainMaster=0");
            }
            else
            {

                trainDB.UpdateTrainMaster(userID, " TrainMaster=1");
            }
        }
