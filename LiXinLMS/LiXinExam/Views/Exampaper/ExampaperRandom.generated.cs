...
<div id=""mdiv"">
    <div class=""exam-sel"">
        ...
        <table name=""subdiv"" class=""tab-Form"">
            ...
            #line 14 "..\..\Views\Exampaper\ExampaperRandom.cshtml"
...
"ue=\"1\">");
            ...
            #line 17 "..\..\Views\Exampaper\ExampaperRandom.cshtml"
...
"");
            ...
            #line 27 "..\..\Views\Exampaper\ExampaperRandom.cshtml"
...
WriteLiteral(@"：</td>
            ...
            #line 35 "..\..\Views\Exampaper\ExampaperRandom.cshtml"
...
WriteLiteral("：</td>\r\n                <td>\r\n                    <span>");
            ...
            #line 37 "..\..\Views\Exampaper\ExampaperRandom.cshtml"
...
WriteLiteral(@"：</span>
            ...
            #line 40 "..\..\Views\Exampaper\ExampaperRandom.cshtml"
...
WriteLiteral(@"：</span>
            ...
            #line 43 "..\..\Views\Exampaper\ExampaperRandom.cshtml"
...
WriteLiteral(@"：</span>
        ...
        <a id=""delDefault1"" name=""rmlink"" title=""");
            ...
            #line 49 "..\..\Views\Exampaper\ExampaperRandom.cshtml"
...
"s=\"mt10\">\r\n    <input type=\"button\" id=\"addDefault\" value=\"");
            ...
            #line 53 "..\..\Views\Exampaper\ExampaperRandom.cshtml"
                                           Write(Exampaper.Add);
...
<script type=""text/javascript"">
    ...
    function selectQuestionSort(idi) {
        ...
        $.getJSON(openurl + ""&t="" + new Date(), function(data) {
            ...
            #line 63 "..\..\Views\Exampaper\ExampaperRandom.cshtml"
...
WriteLiteral("\',\r\n                content: \'");
            ...
            #line 95 "..\..\Views\Exampaper\ExampaperRandom.cshtml"
...
"       for (var g = 0; g < tmp.length; g++) {\r\n            if (tmp[g].value != \"" +
"\" && tmp[g].value != null) {\r\n                var QuestionType = \"#selQuestionTy" +
"pe\" + tmp[g].value;\r\n                var QuestionSort = \"#selQuestionSort\" + tmp" +
"[g].value;\r\n\r\n                if ($(QuestionType).val() != \"\" && $(QuestionSort)" +
".val() != \"\" && $(QuestionType).val() != null && $(QuestionSort).val() != null) " +
"{\r\n                    var que = $(QuestionType).val() + \"|\" + $(QuestionSort).v" +
"al();\r\n                    if (!ckque(que)) {\r\n                        eroor = \"" +
"请不要选择重复的组卷条件\";\r\n                    } else {\r\n                        if (!Check" +
"Level(tmp[g].value)) {\r\n                            eroor = \"难度填写有误\";\r\n         " +
"               }\r\n                    }\r\n                } else {\r\n             " +
...
"onType = \"#selQuestionType\" + numid;\r\n        var QuestionSort = \"#selQuestionSo" +
"rt\" + numid;\r\n        if ($(\"#sortName\" + numid).val() != \"\" && $(\"#sortName\" + " +
"numid).val() != null) {\r\n            var que = $(QuestionType).val() + \"|\" + $(Q" +
"uestionSort).val();\r\n            if (ckque(que)) {\r\n                if (CheckLev" +
"el(numid)) {\r\n                    $(\"#delDefault\" + numid).show();\r\n            " +
"        var mid = parseInt(numid) + 1;\r\n                    var liHTML = \'<div c" +
"lass=\"exam-sel\"><input type=\"hidden\" name=\"random\" value=\"\' + mid + \'\"/><table c" +
"lass=\"tab-Form\" name=\"subdiv\">\';\r\n                    liHTML += \'<tr>\';\r\n       " +
"             liHTML += \'<td class=\"Tit\"><span class=\"must\">*</span>");


            
            #line 263 "..\..\Views\Exampaper\ExampaperRandom.cshtml"
                                                                     Write(Exampaper.qType);
...
WriteLiteral("</option>\';\r\n                    liHTML += \'<option value=\"6\">");
            ...
            #line 270 "..\..\Views\Exampaper\ExampaperRandom.cshtml"
                                            Write(Exampaper.Scene);
...
"          liHTML += \'<td class=\"Tit\"><span class=\"must\">*</span>");
            ...
            #line 272 "..\..\Views\Exampaper\ExampaperRandom.cshtml"
                                                                     Write(Exampaper.qSort);
...
WriteLiteral("：</td>\';\r\n                    liHTML += \'<td><span>");
            ...
            #line 278 "..\..\Views\Exampaper\ExampaperRandom.cshtml"
                                    Write(Question.Question_QuestionManage_EasyLevel);
...
WriteLiteral(@"：</span>';
            ...
            #line 281 "..\..\Views\Exampaper\ExampaperRandom.cshtml"
                                             Write(Question.Question_QuestionManage_CommonLevel);
...
WriteLiteral(@"：</span>';
            ...
            #line 284 "..\..\Views\Exampaper\ExampaperRandom.cshtml"
                                             Write(Question.Question_QuestionManage_HardLevel);
...
WriteLiteral(@"：</span>';
            ...
            #line 288 "..\..\Views\Exampaper\ExampaperRandom.cshtml"
                                                                             Write(CommonLanguage.Common_Delete);
...
WriteLiteral(@""" class=""icon idel""></a>';
            ...
            #line 304 "..\..\Views\Exampaper\ExampaperRandom.cshtml"
                                      Write(CommonLanguage.Common_Tip);
...
"要选择重复的组卷条件\", 1.5);\r\n                //art.dialog({ title: \'");
            ...
            #line 308 "..\..\Views\Exampaper\ExampaperRandom.cshtml"
                                  Write(CommonLanguage.Common_Tip);
...
"1.5);\r\n            //art.dialog({ title: \'");
            ...
            #line 312 "..\..\Views\Exampaper\ExampaperRandom.cshtml"
                              Write(CommonLanguage.Common_Tip);
...
WriteLiteral(@"', content: ""请选择题库"", width: 400, height: 100, fixed: true, lock: true, time: 3 });
    ...
    function bindListener() {
        $(""a[name=rmlink]"").unbind().click(function() {
            ...
            #line 333 "..\..\Views\Exampaper\ExampaperRandom.cshtml"
                                  Write(CommonLanguage.Common_Tip);
...
"  }\r\n                }\r\n                if (eqids != \"\") {\r\n                    " +
"$.ajax({\r\n                        type: \"post\",\r\n                        url: \"/" +
"Exampaper/GetRandomQuestion?randonid=\" + eqids + \"&t=\" + new Date(),\r\n          " +
"              dataType: \"json\",\r\n                        success: function(data)" +
" {\r\n                            var strhtml = \'\';\r\n                            v" +
...
"ntById(Juid) == null) {\r\n                                    strhtml += \'<div cl" +
"ass=\"QSingle\" id=\"QuestionID\' + datelist[i - 1]._id + \'\">\';\r\n                   " +
"                 strhtml += \'<input type=\"hidden\" name=\"\' + datelist[i - 1].Ques" +
"tionType + \'\" value=\"\' + datelist[i - 1]._id + \'|\' + datelist[i - 1].QuestionTyp" +
"e + \'\"/>\';\r\n                                    strhtml += \'<div class=\"title\"><" +
"div class=\"info\"><input id=\"Order\' + datelist[i - 1]._id + \'\" readonly=\"true\" ty" +
"pe=\"text\" name=\"Order\' + datelist[i - 1]._id + \'\"  value=\"\' + i + \'\" maxlength=\"" +
"3\" />.\';\r\n                                    strhtml += \'[ <input id=\"Score\' + " +
"datelist[i - 1]._id + \'\" type=\"text\" name=\"Score\' + datelist[i - 1]._id + \'\" rea" +
"donly=\"true\" value=\"1\" onkeyup=\"verifyInput(this)\" maxlength=\"3\" /> ");
...
WriteLiteral("@\" onclick=\"Delete(\' + datelist[i - 1]._id + \')\" title=\"");
            ...
            #line 381 "..\..\Views\Exampaper\ExampaperRandom.cshtml"
                                                                                                                                                                         Write(CommonLanguage.Common_Delete);
...
" type=\"radio\" disabled=\"disabled\" /><label>");
            ...
            #line 399 "..\..\Views\Exampaper\ExampaperRandom.cshtml"
...
"                          statID();\r\n                            qtype();\r\n     " +
"                       upScore();\r\n                            if (rete > 0) {\r\n" +
"                                art.dialog.tips(\"存在重复试题自动过滤\", 1.5);\r\n           " +
"                     //art.dialog({ title: \'");


            
            #line 429 "..\..\Views\Exampaper\ExampaperRandom.cshtml"
                                                  Write(CommonLanguage.Common_Tip);
...
WriteLiteral(@"', content: ""存在重复试题自动过滤"", width: 400, height: 100, fixed: true, lock: true, time: 3 });
            ...
            #line 435 "..\..\Views\Exampaper\ExampaperRandom.cshtml"
                                              Write(CommonLanguage.Common_Tip);
...
WriteLiteral(@"', content: errorThrown, width: 400, height: 100, fixed: true, lock: true, time: 3 });
            ...
            #line 442 "..\..\Views\Exampaper\ExampaperRandom.cshtml"
                                  Write(CommonLanguage.Common_Tip);
