...
namespace LiXinExam.Views.ExamTest
{
    ...
    public class ExamTestOnline : System.Web.Mvc.WebViewPage<dynamic>
    {
...
"Type==6}}\r\n                    <a class=\"icon iview\" title=\'查看\' onclick=\'Exam.Br" +
"owQuestionFiles({{:QuestionID}});\'></a>\r\n                {{/if}}\r\n            </" +
"dd>\r\n            <dd class=\"questionAnswer\">\r\n                {{if QType==1}}\r\n " +
"                   <!-- 问答题 -->\r\n                    {{for QuestionAnswer}}\r\n   " +
"                     <p><textarea id=\"answer_{{:QuID}}_0\" class=\"Boxarea all50\" " +
"onblur=\"Exam.UpdateUserAnswer({{:QuID}},{{:QType}});\">{{:UserAnswer}}</textarea>" +
"<p>\r\n                    {{/for}}\r\n                {{/if}}\r\n                {{if" +
" QType==2}}\r\n                    <!-- 单选题 -->\r\n                    {{for Questio" +
"nAnswer}}\r\n                        <p><input type=\"radio\" name=\"answer_{{:QuID}}" +
"\" order=\"{{:Order}}\" id=\"answer_{{:QuID}}_{{:Order}}\" onchange=\"Exam.UpdateUserA" +
"nswer({{:QuID}},{{:QType}});\"/>{{:OrderShow}}. {{:AnswerContent}}</p>\r\n         " +
"           {{/for}}    \r\n                {{/if}}\r\n                {{if QType==3}" +
"}\r\n                    <!-- 多选题 -->\r\n                    {{for QuestionAnswer}}\r" +
"\n                        <p><input type=\"checkbox\" id=\"answer_{{:QuID}}_{{:Order" +
"}}\" order=\"{{:Order}}\" onchange=\"Exam.UpdateUserAnswer({{:QuID}},{{:QType}});\"/>" +
"{{:OrderShow}}. {{:AnswerContent}}</p>\r\n                    {{/for}}\r\n          " +
"      {{/if}}\r\n                {{if QType==4}}\r\n                    <!-- 判断题 -->" +
"\r\n                    <p><input type=\"radio\" name=\"answer_{{:QuestionID}}\" order" +
"=\"0\" id=\"answer_{{:QuestionID}}_0\" onchange=\"Exam.UpdateUserAnswer({{:QuestionID" +
"}},{{:QType}});\"/>A. 正确</p>\r\n                    <p><input type=\"radio\" name=\"an" +
"swer_{{:QuestionID}}\" order=\"1\" id=\"answer_{{:QuestionID}}_1\" onchange=\"Exam.Upd" +
"ateUserAnswer({{:QuestionID}},{{:QType}});\"/>B. 错误</p>\r\n                {{/if}}\r" +
"\n                {{if QType==5}}\r\n                    <!-- 填空题 -->\r\n            " +
"    {{/if}}\r\n                {{if QType==6}}\r\n                    <!-- 多选题 -->\r\n" +
"                    {{for QuestionAnswer}}\r\n                        {{if AnswerT" +
"ype==0}}\r\n                            <p><textarea id=\"answer_{{:QuID}}_0\" class" +
"=\"Boxarea all50\" onblur=\"Exam.UpdateUserAnswer({{:QuID}},{{:QType}});\">{{:UserAn" +
"swer}}</textarea></p>\r\n                        {{/if}}\r\n                        " +
"{{if AnswerType!=0}}\r\n                            <p><input type=\"{{:AnswerType=" +
"=1?\"radio\":\"checkbox\"}}\" order=\"{{:Order}}\" name=\"answer_{{:QuID}}\" id=\"answer_{" +
"{:QuID}}_{{:Order}}\" onchange=\"Exam.UpdateUserAnswer({{:QuID}},{{:QType}});\"/>{{" +
":OrderShow}}. {{:AnswerContent}}</p>\r\n                        {{/if}}\r\n         " +
"           {{/for}}\r\n                {{/if}}\r\n            </dd>\r\n        </dl>\r\n" +
"    </div>\r\n\r\n</script>\r\n<!-- 右侧单个显示 -->\r\n<script id=\"questionSingleShowTemplate" +
"\" type=\"text/x-jsrender\">\r\n    <div id=\"order{{:QuestionID}}\"  class=\"singlequ {" +
"{:UserAnswer.length>0?\'done\':\'nodone\'}}\" doflag=\"{{:UserAnswer.length>0?1:0}}\" s" +
"ignflag=\"0\" onclick=\"Exam.GetShowSingleQuestion({{:QuestionID}},{{:QuestionOrder" +
"}});\">\r\n        {{:QuestionOrder}}\r\n    </div>\r\n</script>\r\n<!-- 右侧题目数目统计 -->\r\n<s" +
"cript id=\"questionCountTotalTemplate\" type=\"text/x-jsrender\">\r\n    <div class=\"t" +
"ab-topic\">\r\n        <ul>\r\n            <li onclick=\" Exam.QuestionStatusSelect(th" +
"is,0); \" class=\"On\">全部<div>(<span id=\"quAllTotal\">{{:QuAllTotal}}</span>)</div><" +
"i></i></li>\r\n            <li onclick=\" Exam.QuestionStatusSelect(this,1); \">未完成<" +
"div>(<span id=\"quNoTotal\">{{:QuNoTotal}}</span>)</div><i></i></li>\r\n            " +
"<li onclick=\" Exam.QuestionStatusSelect(this,2); \">已完成<div>(<span id=\"quOverTota" +
"l\">{{:QuOverTotal}}</span>)</div><i></i></li>\r\n            <li onclick=\" Exam.Qu" +
"estionStatusSelect(this,3); \">已标记<div>(<span id=\"quSignTotal\">{{:QuSignTotal}}</" +
"span>)</div><i></i></li>\r\n        </ul>\r\n    </div>\r\n\r\n</script>\r\n<!-- 右侧题目列表 --" +
">\r\n<script id=\"questionCountDetailTemplate\" type=\"text/x-jsrender\">\r\n    <h4>{{:" +
"#data}}</h4>\r\n    <div type=\"{{:#data}}\" class=\"Numlist\"></div>\r\n</script>\r\n<!--" +
" 试题上部的操作按钮模板(单题可逆) -->\r\n<script id=\"examOperationSingleBackTemplate\" type=\"text/" +
"x-jsrender\">\r\n        <input id=\"btnPreQuestion\" value=\"上一题\" type=\"button\" oncli" +
"ck=\"Exam.GetShowQuestionList(1,-1);\" class=\"btn\"/>\r\n        <input id=\"btnNextQu" +
"estion\" value=\"下一题\" type=\"button\" onclick=\"Exam.GetShowQuestionList(1,1);\" class" +
"=\"btn btn-co\"/>\r\n</script>\r\n<!-- 试题上部的操作按钮模板(单题不可逆) -->\r\n<script id=\"examOperati" +
"onSingleNoBackTemplate\" type=\"text/x-jsrender\">\r\n        <input id=\"btnNextQuest" +
"ion\" value=\"下一题\" type=\"button\" onclick=\"Exam.GetShowQuestionList(2,1);\" class=\"b" +
"tn btn-co\" />\r\n</script>\r\n<!-- 试题上部的操作按钮模板(整体显示) -->\r\n<script id=\"examOperationA" +
"llShowTemplate\" type=\"text/x-jsrender\">\r\n    <li onclick=\"Exam.QuestionTypeSelec" +
"t(this,\'{{:#data}}\');\">{{:#data}}</li>\r\n</script>\r\n<!--考试头部信息模板-->\r\n<script id=\"" +
"examTopTemplate\" type=\"text/x-jsrender\">\r\n    <div class=\"examTit\">\r\n        <h2" +
">{{:ExamTitle}}</h2>\r\n        <dl>\r\n            <dd>总分：<strong>{{:ExamScore}}</s" +
...
"        <input type=\"button\" id=\"btnSubmitExam\" onclick=\"Exam.SubmitExam(\'\');\" v" +
"alue=\"提交试卷\" class=\"btn btn-co\"/>\r\n            </dt>\r\n        </dl>\r\n    </div>\r\n" +
"</script>\r\n<!--进入考试提示信息模板-->\r\n<script id=\"examTemplate\" type=\"text/x-jsrender\">\r" +
"\n    <div class=\"exam-info\">\r\n        <div class=\"pic\"></div>\r\n        <table cl" +
"ass=\"tab-Form\">\r\n            <tr><td class=\"Tit\"><i></i>考试总分：</td><td><strong>{{" +
":ExamScore}}</strong>分</td></tr>\r\n            <tr><td class=\"Tit\"><i></i>及格分数：</" +
"td><td><strong>{{:PassScore}}</strong>分</td></tr>\r\n            <tr><td class=\"Ti" +
"t\"><i></i>考试时长：</td><td><strong>{{:ExamLength}}</strong>分钟</td></tr>\r\n          " +
"  <tr><td class=\"Tit\"><i></i>显示方式：</td><td>{{:ExamShowWay==0?\"整卷显示\":(ExamShowWay" +
"==1?\"单题可逆\":\"单题不可逆\")}}</td></tr>\r\n        </table>\r\n        <div class=\"time\">\r\n " +
"           <p>距本场考试还有:<strong id=\"leftTime\"></strong></p>\r\n            <div><inp" +
"ut type=\"button\" class=\"btn-blue\" onclick=\"Exam.StartExamTest();\" id=\"btnGoExam\"" +
" disabled=\"disabled\" value=\"点击进入考试\"/></div>\r\n        </div>\r\n    </div>\r\n    <ul" +
" class=\"examrule\">\r\n        <li><h5>考试必读: </h5></li>\r\n        <li>1、本场考试考试时间为：<s" +
"trong>{{:ExamStartTime}}</strong> 至 <strong>{{:ExamEndTime}}</strong>；</li>\r\n   " +
"     <li>2、当考试时间到了，请点击“<strong>点击进入考试</strong>”，进入考试，同时考试计时开始；</li>\r\n        <li" +
">3、进入考试页面请不要刷新页面，后果自负；</li>\r\n        <li>4、考试倒计时结束会自动交卷，您也可以手动交卷；</li>\r\n        " +
"<li>5、祝大家考出好成绩；</li>\r\n    </ul>\r\n</script>\r\n<!--试题附件查看模板-->\r\n<script id=\"questio" +
"nFileTemplate\" type=\"text/x-jsrender\">\r\n    <table >\r\n        <tr>\r\n            " +
"{{if #data.FileUpload[0]._fileType==0}}\r\n                <td class=\"QSingle\">\r\n " +
"               <center>\r\n                    <div id=\"imageCollection\">\r\n       " +
"                 <a class=\"pl\" onclick=\" turnToNext(this, \'left\'); \"></a>\r\n     " +
"                   <input type=\"hidden\" value=\"1\" />\r\n                        {{" +
"for FileUpload}}\r\n                            <img src=\"../../ClientBin/UploadFi" +
"le/{{:_fileName}}\" style=\"{{:#index == 0 ? \'display:block; \' : \' display:none; \'" +
"}}\" />\r\n                        {{/for}}\r\n                        <a class=\"pr\" " +
"onclick=\" turnToNext(this, \'right\'); \" ></a>\r\n                    </div>\r\n      " +
"          </center>\r\n                </td>\r\n            {{else if #data.FileUplo" +
"ad[0]._fileType==1}}\r\n               <td>\r\n                 {{for FileUpload}}\r\n" +
"                    <embed type=\"application/x-mplayer2\" src=\"../../ClientBin/Up" +
"loadFile/{{:_fileName}}\" name=\"mediaplayer\" width=\"400\" height=\"250\" showcontrol" +
"s=\"1\" showstatusbar=\"0\" showdisplay=\"0\" autostart=\"0\"></embed>\r\n                " +
" {{/for}} \r\n               </td>\r\n            {{else}}\r\n                <td>\r\n  " +
"              {{for FileUpload}}\r\n                 <input name=\"FlvName\" value=\"" +
"{{:_fileName}}\" type=\"hidden\" />\r\n                  <div id=\'{{:_fileName==null?" +
"\"\":_fileName.substring(0,_fileName.length-4)}}\'>\r\n                  </div> \r\n   " +
"             {{/for}}\r\n                </td>\r\n            {{/if}}\r\n        </tr>" +
"\r\n    </table>\r\n</script>\r\n<script type=\"text/javascript\">\r\n\r\n    var timer = 0;" +
"\r\n    $(document).ready(function () {\r\n        //隐藏头部、底部\r\n        //……\r\n\r\n      " +
"  //弹出加载提示\r\n        art.dialog({ width: 400, height: 150, id: \"loadcounter\", con" +
"tent: \'正在加载，请稍后……<span id=\"process\">0%</span>\' });\r\n\r\n        //考试基本信息\r\n        " +
"$.getJSON(\"/ExamTest/GetExaminationInformation?examUserID=");
