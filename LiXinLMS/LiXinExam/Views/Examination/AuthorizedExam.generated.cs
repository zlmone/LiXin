...
namespace LiXinExam.Views.Examination
{
    ...
    public class AuthorizedExam : System.Web.Mvc.WebViewPage<dynamic>
    {
...
"\", 3);\r\n            return;\r\n        }\r\n        $.getJSON(\"/Examination/ExamAd" +
"dAuthorizedPerson\", { newIds: p.ids, oldIds: $(\"#personids\").val(), idsFlag: 0 }" +
", function(data) {\r\n            if (data.Isnull == 1) {\r\n                //谈对话框\r" +
"\n                //art.dialog({ content: \"该部门下没有人员，请重新选择！\", time: 3 });\r\n       " +
"         art.dialog.tips(\"该部门下没有人员，请重新选择\", 3);\r\n                return;\r\n     " +
"       } else {\r\n                $(\"#personids\").val(data.result);\r\n            " +
"    //更新列表\r\n                InitTable();\r\n            }\r\n        });\r\n        ar" +
"t.dialog.list[\'DeptTree\'].close();\r\n    }\r\n\r\n    function SelectPost() {\r\n//    " +
"    var ids = \'\';\r\n//        $(\"#postTree input:checkbox[checked=\'true\']\").each(" +
"function () {\r\n//            ids = ids + $(this).attr(\"id\") + \",\";\r\n//        })" +
";\r\n        //        ids = ids.substring(0, ids.length - 1);\r\n\r\n        var p = " +
"GetPosts();\r\n        if (p.ids == \"\") {\r\n            //art.dialog({ content: \"请选" +
"择岗位！\", time: 3 });\r\n            art.dialog.tips(\"请选择岗位\", 3);\r\n            retu" +
"rn;\r\n        }\r\n        $.getJSON(\"/Examination/ExamAddAuthorizedPerson\", { newI" +
"ds: p.ids, oldIds: $(\"#personids\").val(), idsFlag: 1 }, function(data) {\r\n      " +
"      if (data.Isnull == 1) {\r\n                //谈对话框\r\n                //art.dia" +
"log({ content: \"该岗位下没有人员，请重新选择！\", time: 3 });\r\n                art.dialog.tips(\"" +
"该岗位下没有人员，请重新选择\", 3);\r\n                return;\r\n            } else {\r\n         " +
"       $(\"#personids\").val(data.result);\r\n                //更新列表\r\n              " +
"  InitTable();\r\n            }\r\n        });\r\n        art.dialog.list[\'PostTree\']." +
"close();\r\n    }\r\n\r\n    function GetUserIDList() {\r\n        if ($(\"#SelectUserFla" +
"g\").val() == \"AuthorizedExam\") {\r\n            var userAdd = GetChecked(\'pop_user" +
"List\');\r\n            if (userAdd == \"\") {\r\n                //art.dialog({ conten" +
"t: \"请选择人员！\", time: 3 });\r\n                art.dialog.tips(\"请选择人员\", 3);\r\n      " +
"          return;\r\n            }\r\n\r\n            $.getJSON(\"/Examination/ExamAddA" +
"uthorizedPerson\", { newIds: userAdd, oldIds: $(\"#personids\").val(), idsFlag: 2 }" +
", function(data) {\r\n                if (data.Isnull == 1) {\r\n                   " +
...
"rAdd2 = GetChecked(\'pop_userList\');\r\n            if (userAdd2 == \"\") {\r\n        " +
"        //art.dialog({ content: \"请选择批阅人！\", time: 3 });\r\n                art.dial" +
"og.tips(\"请选择批阅人\", 3);\r\n                return;\r\n            }\r\n            $.g" +
"etJSON(\"/Examination/ExamAddAuthorizedPerson\", { newIds: userAdd2, oldIds: $(\"#A" +
"pprovalUserIds\").val(), idsFlag: 2 }, function(data) {\r\n                if (data" +
".Isnull == 1) {\r\n                    //谈对话框\r\n                } else {\r\n         " +
...
"sonlist\").addClass(\"Piclist\").removeClass(\"Wordlist\");\r\n//            templateId" +
" = \'userBlockTemlpate\';\r\n//        }\r\n\r\n\r\n        $(\"#personlist\").JsRenderData(" +
"{\r\n            sourceUrl: \'/Examination/GetAuthorizedExamUserList?userIds=\' + $(" +
...
"  function ChangtbExamSendStudent(examId) {\r\n        $.getJSON(\"/Examination/Cha" +
"ngtbExamSendStudent\", { personids: $(\"#personids\").val(), examId: examId }, func" +
"tion(data) {\r\n            if (data.result == 1) {\r\n                art.dialog({\r" +
"\n                    content: \"保存成功！\",\r\n                    time: 3,\r\n          " +
