...
namespace LiXinExam.Views.Examination
{
    ...
    public class EditExamination : System.Web.Mvc.WebViewPage<LiXinModels.Examination.DBModel.tbExamination>
    {
...
"aperName\'>\" + paperName.html() + \" <a class=\'btn btn-cancel\' onclick=\'removeRelP" +
"aper()\'>X</a></li>\";\r\n        paperHtml += \"</ul></div>\";\r\n        $(\"#lbl_Paper" +
"Name\").html(paperHtml);\r\n        art.dialog.list[\'SelExam\'].close();\r\n    }\r\n\r\n " +
"   function submitExam(form) {\r\n        if ($(\"#txt_PublishedFlag\").val() == 1) " +
"{\r\n            if ($(\"#personids\").val().length == 0) {\r\n                //art.d" +
"ialog({ content: \"发布考试必须有考生参加！\", time: 3 });\r\n                art.dialog.tips(\"发" +
"布考试必须有考生参加\", 3);\r\n                return;\r\n            }\r\n\r\n            art.di" +
"alog({\r\n                content: \'考试发布之后不可修改，确认发布吗？\',\r\n                ok: funct" +
"ion () {\r\n                    $(\"#btnSave\").removeAttr(\"onclick\");\r\n            " +
"        $(\"#btnPublish\").removeAttr(\"onclick\");\r\n                    \r\n         " +
"           $.post(\"/Examination/SubmitEditExamination?personIds=\" + $(\"#personid" +
"s\").val() + \"&ApprovalUser=\" + $(\"#ApprovalUserIds\").val(), $(\"#fro_EditExaminat" +
"ion\").formSerialize(), function (data) {\r\n                        \r\n            " +
"            art.dialog.tips(data.content, 3, function () {\r\n                  " +
"          if (data.result == 1) {\r\n                                window.locati" +
"on.href = \'/Examination/ExaminationList\';\r\n                            }\r\n      " +
"                      else {\r\n                                $(\"#btnSave\").attr" +
"(\"onclick\", \"SaveExam()\");\r\n                                $(\"#btnPublish\").att" +
"r(\"onclick\", \"PublishedExam()\");\r\n                            }\r\n               " +
"         });\r\n                    });\r\n                    return true;\r\n       " +
"         },\r\n                cancelVal: \'关闭\',\r\n                cancel: true //为t" +
"rue等价于function(){}\r\n            });\r\n        } else {\r\n            $(\"#btnSave\")" +
".removeAttr(\"onclick\");\r\n            $(\"#btnPublish\").removeAttr(\"onclick\");\r\n  " +
"          $.post(\"/Examination/SubmitEditExamination?personIds=\" + $(\"#personids" +
"\").val() + \"&ApprovalUser=\" + $(\"#ApprovalUserIds\").val(), $(\"#fro_EditExaminati" +
"on\").formSerialize(), function(data) {\r\n                \r\n                art.di" +
"alog.tips(data.content, 3, function () {\r\n                    $(\"#txt_id\").val" +
"(data.examId);\r\n                    if (data.result == 1) {\r\n                   " +
"     window.location.href = \'/Examination/ExaminationList\';\r\n\r\n                 " +
"   }\r\n                    else {\r\n                        $(\"#btnSave\").attr(\"on" +
"click\", \"SaveExam()\");\r\n                        $(\"#btnPublish\").attr(\"onclick\"," +
" \"PublishedExam()\");\r\n                    }\r\n                });\r\n            })" +
";\r\n        }\r\n    }\r\n\r\n    function PublishedExam() {\r\n        $(\"#txt_Published" +
"Flag\").val(1);\r\n        $(\"#fro_EditExamination\").submit();\r\n    }\r\n\r\n    functi" +
"on SaveExam() {\r\n        $(\"#txt_PublishedFlag\").val(0);\r\n        $(\"#fro_EditEx" +
"amination\").submit();\r\n    }\r\n\r\n    function AddApprovalUser() {\r\n        $(\"#AU" +
"ser\").html(\"\");\r\n        $.getJSON(\"/Examination/GetUserByIds\", { ids: $(\"#Appro" +
"valUserIds\").val() }, function (data) {\r\n            var html = \"\";\r\n           " +
" if (data.data.length > 0) {\r\n                html += \"<div class=\'seled-list\'><" +
"h4>已选择批阅人：</h4><ul>\";\r\n                for (var i = 0; i < data.data.length; i++" +
") {\r\n                    var tagId = \"Tag_\" + data.data[i].UserId;\r\n            " +
"        //$(\"#AUser\").prepend(\'<li id=\' + tagId + \'><span title=\' + data.data[i]" +
".Realname + \'>\' + data.data[i].Realname + \'</span><a class=\"btn btn-cancel\" oncl" +
"ick=\"removeApprovalUser(\\\'\' + data.data[i].UserId + \'\\\')\">X</a></li>\');\r\n       " +
"             html += \"<li id=\'\" + tagId + \"\'><span title=\'\" + data.data[i].Realn" +
"ame + \"\' >\" + data.data[i].Realname + \"</span><a onclick=\'removeApprovalUser(\" +" +
" data.data[i].UserId + \")\' class=\'btn btn-cancel\'>X</a></li>\";\r\n                " +
"}\r\n                html += \"</ul></div>\";\r\n\r\n                $(\"#AUser\").prepend" +
"(html);\r\n            }\r\n            $(\"#ApprovalUserIds\").val(data.ids);\r\n      " +
"  });\r\n    }\r\n\r\n    function removeApprovalUser(tagId) {\r\n        $(\"#Tag_\" + ta" +
"gId).remove();\r\n        var tagArray = [];\r\n        tagArray = $(\"#ApprovalUserI" +
"ds\").val().split(\",\");\r\n        $.arrayRemove(tagArray, tagId);\r\n        $(\"#App" +
"rovalUserIds\").val(tagArray.join(\",\"));\r\n    }\r\n\r\n    function removeRelPaper() " +
"{\r\n        $(\"#sp_paperName\").html(\"\");\r\n        $(\'#hid_PaperId\').val(0);\r\n    " +
"}\r\n\r\n    function fnback() {\r\n        window.location.href = \'/Examination/Exami" +
"nationList\';\r\n    }\r\n</script>");
